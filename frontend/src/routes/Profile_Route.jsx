		...
		<>
			<div id="wrapper">
				...
				<div className="flex flex-col justify-center items-center bg-(--purple-dark) w-full text-(--orange-main) px-8 py-10">
					<h1 className="text-4xl text-(--orange-main) font-bold font-kanit pt-2 mb-8">
						{" "}
						YOUR CIRCLES
					</h1>
					<div className="flex flex-wrap justify-center gap-8 px-4 sm:px-20 ">
						<Avatar
							name="Greg"
							src="https://vshrt.in/SYKA"
							tierColor="silver"
						/>
						<Avatar
							name="Candide"
							src="https://vshrt.in/Txly"
							tierColor="gold"
						/>
						<Avatar
							name="California"
							src="https://vshrt.in/CfqD"
							tierColor="bronze"
						/>
						<Avatar
							name="Greg"
					...
					<h2 className="text-2xl font-kanit mt-8 mb-4 font-bold">
						MORE ABOUT CRICLES:
					</h2>
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum,
						magni obcaecati. Adipisci repudiandae voluptates, tempore nam quidem
						voluptate quis consequatur repellat. Quisquam eligendi, suscipit qui
						consequuntur doloribus deserunt atque incidunt.
					</p>
				</div>
			</div>
		</>
